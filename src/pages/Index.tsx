      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-screen p-4 md:p-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-12 animate-fade-in-up">
            CÔNG TY ĐẠI LONG MEDIA với mục tiêu xây dựng hệ sinh thái dịch vụ toàn diện giúp doanh nghiệp làm chủ truyền thông và số hoá cho doanh nghiệp siêu nhỏ. Giúp doanh nghiệp có sức khoẻ thương hiệu và bán hàng bền vững.
          </p>
        </div>
